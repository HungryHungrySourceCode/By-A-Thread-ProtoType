...
Shader "Custom/Grass" {
     ...
     _Cutoff ("Alphacutoff" , Range( 0 ,1 ))= 0.5
          _ShakeDisplacement ("ShakeDisplacement" , Range( 0 ,200 ))= 0.5
					          _ShakeTime ("ShakeTime" , Range( 0 ,20 ))= 0.5
							            _ShakeWindspeed ("ShakeWindspeed" , Range( 0 ,20 ))= 0.5
										          _ShakeBending ("ShakeBending" , Range( 0 ,20 ))= 0.5
												            WindDirectionx ("WindDirectionx" , float)= 0.5
															          WindDirectionz ("WindDirectionz" , float)= 0.5
     }
